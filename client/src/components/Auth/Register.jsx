    ...
    <div className="flex justify-center items-center h-screen bg-green-900">
      <div className="max-w-md w-full mx-auto p-6 bg-lime-400 rounded-lg shadow-lg">
        <div className="text-center pb-8">
          <div className="mt-5">
            <h3 className="text-green-800 text-2xl font-bold sm:text-3xl">Sign up</h3>
          </div>
        </div>
        {loading ? (
          <div className="text-center">Loading...</div>
        ) : success ? (
          <div className="text-center">Registration successful. Redirecting to login...</div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button className="w-full px-4 py-2 text-white font-medium bg-green-500 hover:bg-green-800 active:bg-indigo-600 rounded-lg duration-150">
              Sign up
            </button>
          </form>
        )}
        ...
        <p className="text-center">Already have an account? <Link to={"/login"}><a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500">Sign in</a></Link></p>
      </div>
    </div>
  );
}
